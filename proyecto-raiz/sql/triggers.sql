...
-- =====================================================
--  TRIGGER 1: Prevenir borrado del último admin (en usuarios)
-- =====================================================
...
-- =====================================================
--  TRIGGER 2: Check roles al insertar (en usuarios_grupos)
-- =====================================================
...
-- =====================================================
--  TRIGGER 3: Check roles al actualizar (en usuarios_grupos)
-- =====================================================
...
BEGIN
    ...
    -- CASO 1: ASCENSO (prevenir MÁS de 2)
    ...
    -- CASO 2: DESCENSO (prevenir MENOS de 1)
